...
int LoadRasterFont(RASTERFONT * rasterFont)
{
	...
	unsigned char letterD[]={	//6x7
		0xe9, 0xff, 0xff, 0xff, 0x9c, 0x00,
		0xe9, 0x9c, 0x00, 0x6b, 0xe9, 0xaa,
		0xe9, 0x9c, 0x00, 0x00, 0xad, 0xf4,
		0xe9, 0x9c, 0x00, 0x00, 0x6b, 0xff,
		0xe9, 0x9c, 0x00, 0x00, 0x7d, 0xf4,
		0xe9, 0x9c, 0x00, 0x6b, 0xe9, 0x9c,
		0xe9, 0xff, 0xff, 0xff, 0x9c, 0x00
	};


	unsigned char letterF[]={	//6x7
		0x42, 0xff, 0xff, 0xff, 0xff, 0x8d,
		0x42, 0xff, 0x42, 0x00, 0x00, 0x00,
		0x42, 0xff, 0x42, 0x00, 0x00, 0x00,
	...
	unsigned char letterS[]={	//7x7
		0x00, 0x6b, 0xf4, 0xff, 0xff, 0xe9, 0x00,
		0x00, 0xf4, 0x9c, 0x00, 0x8d, 0x9c, 0x00,
		0x00, 0xf4, 0xb8, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x6b, 0xdd, 0xff, 0xff, 0x9c, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x58, 0xff, 0x58,
		0x42, 0xdd, 0x58, 0x00, 0x6b, 0xff, 0x58,
		0x26, 0xc5, 0xff, 0xff, 0xff, 0x9c, 0x00

	};

	unsigned char letterT[]={	//7x7
		0xb8, 0xff, 0xff, 0xff, 0xff, 0xff, 0x42,
		0x00, 0x00, 0x6b, 0xe9, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x6b, 0xe9, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x6b, 0xe9, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x6b, 0xe9, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x6b, 0xe9, 0x00, 0x00, 0x00,
	...
	unsigned char letterW[]={	//9x7
		0xaa, 0xaa, 0x00, 0x00, 0x00, 0x00, 0x00, 0xaa, 0xaa,
		0x7d, 0xdd, 0x00, 0x6b, 0xff, 0x58, 0x00, 0xdd, 0x7d,
		0x26, 0xff, 0x26, 0xaa, 0xf4, 0x9c, 0x26, 0xff, 0x26,
		0x00, 0xdd, 0x7d, 0xdd, 0x9c, 0xc5, 0x7d, 0xdd, 0x00,
		0x00, 0xaa, 0x9c, 0xf4, 0x26, 0xff, 0xb8, 0xaa, 0x00,
		0x00, 0x7d, 0xf4, 0xb8, 0x00, 0xd1, 0xff, 0x7d, 0x00,
		0x00, 0x26, 0xff, 0x7d, 0x00, 0x9c, 0xff, 0x26, 0x00
	};
	...
	rasterFont->c['D'] = malloc(sizeof(RASTERCHAR));
	rasterFont->c['D']->width=6;
	rasterFont->c['D']->height=7;
	rasterFont->c['D']->pixelarray=malloc(6*7);
	pixelarray=rasterFont->c['D']->pixelarray;
	memcpy(pixelarray, letterD, 6*7);



	rasterFont->c['F'] = malloc(sizeof(RASTERCHAR));
	rasterFont->c['F']->width=6;
	rasterFont->c['F']->height=7;
	rasterFont->c['F']->pixelarray=malloc(6*7);
	pixelarray=rasterFont->c['F']->pixelarray;
	memcpy(pixelarray, letterF, 6*7);
	...
	rasterFont->c['S'] = malloc(sizeof(RASTERCHAR));
	rasterFont->c['S']->width=7;
	rasterFont->c['S']->height=7;
	rasterFont->c['S']->pixelarray=malloc(7*7);
	pixelarray=rasterFont->c['S']->pixelarray;
	memcpy(pixelarray, letterS, 7*7);

	rasterFont->c['T'] = malloc(sizeof(RASTERCHAR));
	rasterFont->c['T']->width=7;
	rasterFont->c['T']->height=7;
	rasterFont->c['T']->pixelarray=malloc(7*7);
	pixelarray=rasterFont->c['T']->pixelarray;
	memcpy(pixelarray, letterT, 7*7);

	rasterFont->c['W'] = malloc(sizeof(RASTERCHAR));
	rasterFont->c['W']->width=9;
	rasterFont->c['W']->height=7;
	rasterFont->c['W']->pixelarray=malloc(9*7);
	pixelarray=rasterFont->c['W']->pixelarray;
	memcpy(pixelarray, letterW, 9*7);
